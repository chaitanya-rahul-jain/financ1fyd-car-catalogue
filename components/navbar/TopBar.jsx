...
const TopBar = () => {
  return (
    <div className="bg-slate-300 flex justify-end items-center gap-10 py-3 px-8 max-[1130px]:hidden">
      ...
      <div className="flex gap-4">
        <FaFacebookSquare className="text-gray-600 text-2xl" />
        <FaInstagram className="text-gray-600 text-2xl" />
        <FaTiktok className="text-gray-600 text-2xl" />
      </div>
    </div>
  );
};
